...
function AboutEthMexEvent() {
  ...
  return (
    <div className="container-fluid align-items-center justify-content-center text-center container-ethmex-event about-ethmex">
      <div className="d-flex justify-content-center align-items-center align-items-lg-start gap-3 gap-lg-5 flex-column flex-lg-row  mx-auto">
        ...
        <div className="about-ethmex-div-white text-center text-lg-start p-4">
          ...
          <br/><br/>
          <span className="text-event" >ETH México es un evento anual y en esta edición, hackathon Web3 que </span><span className="text-event-green">impulsa el desarrollo del ecosistema Ethereum en el país.</span>
          <br/><br/>
